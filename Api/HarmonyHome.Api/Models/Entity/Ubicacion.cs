...
namespace HarmonyHome.Api.Models.Entity
{
    public class Ubicacion
    {
        ...
        [MaxLength(50, ErrorMessage = "El código de la ubicación no puede superar los 50 caracteres.")]
        public string Codigo { get; set; } = string.Empty;

        [Required(ErrorMessage = "El nombre de la ubicación es obligatorio.")]
        [MaxLength(100, ErrorMessage = "El nombre de la ubicación no puede superar los 100 caracteres.")]
